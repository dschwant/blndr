...
class VIEW3D_TP_Multi_Boolean_Props(bpy.types.PropertyGroup):
...
def register():    
    ...
    # PROPS #  
    bpy.types.WindowManager.tp_props_multibool = bpy.props.PointerProperty(type = VIEW3D_TP_Multi_Boolean_Props)
